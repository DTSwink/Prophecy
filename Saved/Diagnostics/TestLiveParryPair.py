...
folder=pathlib.Path(unreal.Paths.project_saved_dir())/'Diagnostics/LiveParryPair'
...
def finish(result,error=''):
    ...
    report.update(result=result,error=error,scope='Two actual testNN PIE actors, live attack and parry NN, kinematic presentation; no prerecorded poses.')
