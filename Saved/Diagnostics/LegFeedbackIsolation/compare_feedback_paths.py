...
assert not ed.get_game_world(), 'End the current PIE before running the isolated comparison'
unreal.SystemLibrary.execute_console_command(ed.get_editor_world(),'Prophecy.NNLowerFeedbackAlignment '+('0' if mode=='legacy_feedback' else '1'))
