...
unreal.SystemLibrary.execute_console_command(ed.get_editor_world(),'Prophecy.Debug.DodgeContinueAfterContact 1')
code=(pathlib.Path(unreal.Paths.project_saved_dir())/'Diagnostics/capture_current_dodge_mismatch.py').read_text()
code=code.replace("'corrected_ue.json'","'trace_continue_ue.json'")
