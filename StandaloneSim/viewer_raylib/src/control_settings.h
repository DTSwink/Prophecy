...
struct ControlSettings {
    ...
    float containment_early_influence = ::prophecy::sim::kDefaultContainmentEarlyInfluence;
    ...
    float crawl_speed_scale = ::prophecy::sim::kDefaultCrawlSpeedScale;
    ...
    float drawn_sword_attack_probability =
        ::prophecy::sim::kDefaultDrawnSwordAttackProbability;
...
constexpr float kMinContainmentEarlyInfluence = 0.0f;
constexpr float kMaxContainmentEarlyInfluence = 0.2f;
...
constexpr float kMinCrawlScale = 0.0f;
constexpr float kMaxCrawlScale = 1.0f;
constexpr float kMinAttackCooldown = 0.0f;
constexpr float kMaxAttackCooldown = 5.0f;
constexpr float kMinAttackFollowupProbability = 0.0f;
constexpr float kMaxAttackFollowupProbability = 1.0f;
constexpr float kMinDrawnSwordAttackProbability = 0.0f;
constexpr float kMaxDrawnSwordAttackProbability = 1.0f;
