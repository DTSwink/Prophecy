...
class GAMEANIMATIONSAMPLE3_API UProphecyAgentResetLibrary : public UBlueprintFunctionLibrary
{
    GENERATED_BODY()
public:
    /** Call once after NN initialization and delayed BeginPlay physics/profile setup, before starting movement. Captures the agents currently
     ...
     * Restores captured magnetization, tolerance/damping profiles, tempering, material override
     * and angular limits; cancels ongoing blends. Keeps simulation mode and other NN tuning.
     * Does not reset arbitrary Blueprint variables.
