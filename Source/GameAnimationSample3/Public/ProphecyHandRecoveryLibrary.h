...
public:
     ...
     * Locomotion only: attack/parry/dodge bypass it. Shared recovery profile for all attacks.
    ...
    /** Hand-only recovery after any attack. Walk/Run conditions the SAME upper checkpoint
     ...
     * that hand. No kick variant. Configure before attack or in On Attack Ended.
